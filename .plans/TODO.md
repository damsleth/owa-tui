...
- [ ] owa-cal & owa-graph: 'q' should return to the tuis menu (like other tools), not quit to terminal
- [ ] All TUIs: configurable top row, default shows current profile + current user's UPN
- [ ] All TUIs: add left and top padding
- [ ] UI theme: optional transparent background (use native terminal background)
